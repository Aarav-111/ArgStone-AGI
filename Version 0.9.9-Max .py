...
system_prompt = f"""
Give {num_of_answers} distinct answers (No Duplicates). For each, show the full calculation or step-by-step working that leads to that answer, as if solving it on paper. Do not rank the answers.
"""
